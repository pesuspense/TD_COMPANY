...
Class clsDBHelper
	...
	Private sub Class_Initialize()
		DefaultConnString = "Provider=SQLOLEDB;"
		DefaultConnString = DefaultConnString &"Data Source=sql19-002.cafe24.com;"
		DefaultConnString = DefaultConnString &"Initial Catalog=okaraamc4424;"
		DefaultConnString = DefaultConnString &"user ID=okaraamc4424;"
		DefaultConnString = DefaultConnString &"password=okaraamc4424_;"
		DefaultConnString = DefaultConnString &"Network Library=DBMSSOCN;"
...
'---------------------------------------------------
	Public Function ReturnConnection()
		ReturnConnection = DefaultConnString
	End Function
			...
			For i = LBound(params) To UBound(params)
				...
				If u - l = 4 Then
					...
					Else
						v = params(i)(4)
					End If
					'Response.Write params(i)(0) &"|"& params(i)(1) &"|"& params(i)(2) &"|"& params(i)(3) &"|"& v
					'Response.Write params(i)(0) &"|"& params(i)(1) &"|"& params(i)(2) &"|"& params(i)(3)
