...
function doClick(e) {															// 날자를 선택하였을 경우
	...
	//추가함수
	if(target.attr == "reAction"){
		target.focus();
	}

	//이벤트발생
	if(target.getAttribute("afterevent") == "blur"){
...
function Show_cal(sYear, sMonth, sDay) {
	...
	Cal_HTML = "<TABLE WIDTH=160 BORDER=0 CELLPADDING=0 CELLSPACING=0 ONMOUSEOVER='javascript:doOver(event);' ONMOUSEOUT='javascript:doOut(event);' STYLE='font-size:8pt;font-family:Tahoma;'>"
			...
			+ "<TR ALIGN=CENTER BGCOLOR=ThreedFace STYLE='color:White;font-weight:bold;'><TD>S</TD><TD>M</TD><TD>T</TD><TD>W</TD><TD>T</TD><TD>F</TD><TD>S</TD></TR>";
