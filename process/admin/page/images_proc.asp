...
Set	uploadform							= Server.CreateObject("DEXT.FileUpload")
		uploadform.DefaultPath	= server.mappath(CFG_FOLDER_META)
...
If answer = "ok" Then
	...
	Case "w"
		...
		queryFileName			= server.mappath(CFG_FOLDER_META) &"\"& CFG_SES_NUM  &".txt"
