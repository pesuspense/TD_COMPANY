...
<%
    ...
    Dim sendurl,postData
    Dim sms_url
 
    Dim user_id					: user_id				= "goodchois2879"												'SMS 아이디
    Dim secure					: secure				= "af2b311c7301b902fcf337deec2615c0"		'인증키
    ...
    sphone3				= "8819"
		...
		msg						= ""
		msg						= msg & "[상담문의]"													&vbCrlf
		msg						= msg & "이름:"			& "도라애몽"								&vbCrlf
		msg						= msg & "연락처:"		& "010-2530-8691"				&vbCrlf
		msg						= msg & "문의내용:"	& "도라미를 찾아요~"					&vbCrlf
